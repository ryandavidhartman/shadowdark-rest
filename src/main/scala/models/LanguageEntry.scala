...
object LanguageEntry {
  ...
  implicit val jsonEncoder: JsonEncoder[LanguageEntry] = DeriveJsonEncoder.gen[LanguageEntry]
  implicit val jsonDecoder: JsonDecoder[LanguageEntry] = DeriveJsonDecoder.gen[LanguageEntry]
}

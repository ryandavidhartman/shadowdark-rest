// Seed the Deities collection from the core list.
// Run with: mongosh --file data/seed-deities.js "mongodb://localhost:27017/shadowdark"
...
const deities = JSON.parse(fs.readFileSync('data/deities.json', 'utf8'));
...
collection.insertMany(deities.map(deity => ({ _id: new ObjectId(), ...deity })));

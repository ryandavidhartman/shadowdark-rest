// Seed the NpcQualities collection from the NPC qualities table.
// Run with: mongosh --file data/seed-npc-qualities.js "mongodb://localhost:27017/shadowdark"
...
const qualities = JSON.parse(fs.readFileSync('data/npc-qualities.json', 'utf8'));
...
collection.insertMany(qualities.map(q => ({ _id: new ObjectId(), ...q })));
